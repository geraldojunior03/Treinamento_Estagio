...
const displayTasks = () => {
  ...
  Array.from(editTasks).forEach((element, index) => {
    element.addEventListener("click", (e) => {
      ...
      titleTask.innerText = "Edição da Task: "
      nameTask.innerText = parent.textContent
      addButton.innerText = "Renomear"
    });
  });
  ...
  Array.from(deleteTasks).forEach((element, index) => {
    element.addEventListener("click", (e) => {
      e.stopPropagation();
      let parent = element.parentElement;
      var confirmarDelete = confirm("Deseja deletar a task: " + parent.textContent + "?")
...
const updateStorage = (index, taskValue, completed) => {
  ...
  titleTask.innerText = "Lista de Tarefas"
  nameTask.innerText = ""
};
